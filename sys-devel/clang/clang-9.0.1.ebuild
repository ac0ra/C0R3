...
MANPAGES_P="llvm-9.0.0-manpages"
MY_P=clang-${PV/_/}.src
...
SRC_URI="https://github.com/llvm/llvm-project/releases/download/llvmorg-${PV/_//}/${MY_P}.tar.xz
	https://github.com/llvm/llvm-project/releases/download/llvmorg-${PV/_//}/${EXTRA_P}.tar.xz
	test? ( https://releases.llvm.org/${PV/_//}/${LLVM_P}.tar.xz )
	!doc? ( https://dev.gentoo.org/~mgorny/dist/llvm/${MANPAGES_P}.tar.bz2 )"
...
src_unpack() {
	...
	if ! use doc; then
		einfo "Unpacking llvm-9.0.0-manpages.tar.bz2 ..."
		tar -xf "${DISTDIR}/llvm-9.0.0-manpages.tar.bz2" || die
	fi
}
...
multilib_src_install_all() {
	...
	if ! use doc; then
		...
		doins "${WORKDIR}/x/y/${MANPAGES_P}/clang"/*.1
	fi
