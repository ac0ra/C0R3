...
src_configure() {
	...
	find ${S} -name "*.txt" -type f | xargs  sed -i "s/target_link_libraries (openvasmd/target_link_libraries (openvasmd openvas_misc openvas_nasl openvas_hg gnutls openvas_base/g" || die "sed failed"
